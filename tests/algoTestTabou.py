...
puis calcule des tournées par camion en utilisant une Recherche Tabou
pour optimiser l'ordre des key nodes (depôt -> pickups -> client).

Usage :
    python -m tests.algoTest  # ou exécuter directement ce fichier selon ton organisation
